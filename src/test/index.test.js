...
describe('Operaciones de Sort', () => {
  ...
  test('sortByColumn ordena las filas (excluyendo encabezado) de forma ascendente', () => {
    const result = sortByColumn(2, 'asc')(matrix);
    const expected = [
      ['Name', 'Age'],
      ['Carol', '20'],
      ['Alice', '25'],
  ...
  test('sortByColumn ordena las filas (excluyendo encabezado) de forma descendente', () => {
    const result = sortByColumn(2, 'desc')(matrix);
    const expected = [
      ['Name', 'Age'],
      ['Bob', '30'],
      ['Alice', '25'],
